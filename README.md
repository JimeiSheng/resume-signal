...
## Features
- Step-by-step prompts guide users to enter experiences  
- Automatically transforms casual language into professional, impact-oriented statements  
- Supports multiple experiences: work, projects, and extracurriculars  
- Export-ready résumé text for easy copy-paste or further formatting  
